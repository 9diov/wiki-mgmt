...
IN JAPAN, THE family name appears first. Thus, the famed inventor of the Toyota production system is known in Japan as Ono Taiichi, and not Taiichi Ohno as usually written in the West.
...
Also, when romanizing Japanese characters, a macron is used over a long vowel in all Japanese words except for wellknown place names (Kyoto, Tokyo), words that have entered the English language (shogun, daimyo), and individual's names in which customarily the macron is replaced by an h (Ohno, not Ono).
